          ...
          Container(
            ...
            child: BlocProvider(
              ...
              child: BlocBuilder<PrayerTimesBloc, PrayerTimesState>(
                ...
                DateTime fajr = DateTime.parse(
                    "${DateTime.parse("${DateTime.now().year}-0${DateTime.now().month}-0${DateTime.now().day} ${state.timings?.fajr ?? '00'}:00")}");
                ...
                int calculateHoursNowPlus12 = int.parse(TestTimer
                        .convert24To12PrayerTimeHourOnly(DateTime.parse(
                                '1969-07-20 ${state.timings?.fajr ?? '00:00'}:04Z').hour)) - 0;
                int calculateHoursNowMinus12 =
                    12 - int.parse(TestTimer.convert24To12NowTimeHourOnly());
